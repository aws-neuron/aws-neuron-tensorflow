...
def inference_graph_from_session(
    ...
    Generally decomposes into 5 passes:
        ...
        4. Call infa-cc compiler on each `InferentiaOp`.
    ...
    Args:
        ...
        compiler_timeout: Integer representing maximum allowed runtime for the infa-cc compiler.
        compiler_recovery: Bool representing whether to recovery from infa-cc compiler failure.
...
def whitelist_partition(graph_def, input_tensors=None, output_tensors=None,
    ...
    if op_whitelist is None:
        command = ['infa-cc', 'list-operators', '--framework', 'TENSORFLOW']
            ...
            with open('/proc/meminfo') as f:
                for line in f:
                    if 'MemAvailable' in line:
                        ...
                        break
            num_mem_gb = int(available_mem_in_kb / 4e6)  # 4 GB memory for each infa-cc process
...
def _fork_compiler(subgraph_compilers, node_name, timeout):
    ...
    if logfile is None:
        ...
        logging.info('fusing subgraph {} with infa-cc; log file is at {}'.format(node_name, logfile))
