...
#ifndef TENSORFLOW_CONTRIB_KAENA_SEGMENT_UNION_FIND_H_
#define TENSORFLOW_CONTRIB_KAENA_SEGMENT_UNION_FIND_H_
...
#endif  // TENSORFLOW_CONTRIB_KAENA_SEGMENT_UNION_FIND_H_
